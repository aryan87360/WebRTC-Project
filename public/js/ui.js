...
function truncateString(inputString) {
  // Check if the input is already 10 characters or less
  if (inputString.length <= 10) {
    return inputString;
  }

  // Truncate the string to 10 characters and add "..."
...
export const updatePersonalCode = (personalCode) => {
  ...
  personalCodeParagraph.innerHTML = truncateString(personalCode);
};
